...
1) Power boards- These boards are Switching Regulators designed to power the microcontronller, Current Switch Board (Will be mentioned later) and a raspberry pi module.
